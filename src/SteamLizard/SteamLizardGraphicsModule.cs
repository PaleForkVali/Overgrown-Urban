...
public class SteamLizardGraphicsModule : LizardGraphics
{
	public SteamLizardGraphicsModule(PhysicalObject owner) : base(owner)
	{
		...
		// limbs[4] = limbs[2];
		// limbs[5] = limbs[3];
		limbs[4] = new LizardLimb(this, owner.bodyChunks[1], 4, 2.5f, 0.7f, 0.99f, lizard.lizardParams.limbSpeed,
			lizard.lizardParams.limbQuickness, null);
		limbs[5] = new LizardLimb(this, owner.bodyChunks[1], 5, 2.5f, 0.7f, 0.99f, lizard.lizardParams.limbSpeed,
		...
		// }
		bodyParts[bodyParts.Length - 2] = limbs[4];
		bodyParts[bodyParts.Length - 1] = limbs[5];
